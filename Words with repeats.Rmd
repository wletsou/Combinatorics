...
\begin{equation}
k^n-\prod_{j=0}^{n-1}\left(n-j\right),
...
\begin{equation}
k^n-\sum_{j=0}^{x-1}\binom{n}{j}\left(k-1\right)^{n-j},
(#eq:1words)
...
\begin{equation}
\sum_{j=0}^{x-1}\binom{n}{j}f^{n-j}_{k-1}\left(x\right),
(#eq:non1words)
...
\begin{equation}
f_k^n\left(x\right)=\left(k^n-\sum_{j=0}^{x-1}\binom{n}{j}\left(k-1\right)^{n-j}\right)+\sum_{j=0}^{x-1}\binom{n}{j}f^{n-j}_{k-1}\left(x\right),
(#eq:recursive)
...
\begin{equation}
k^n-\sum_{j=x+1}^{n}\binom{n}{j}\left(k-1\right)^{n-j},
(#eq:1wordsrev)
...
\begin{equation}
\sum_{j=x+1}^{n}\binom{n}{j}g^{n-j}_{k-1}\left(x\right),
(#eq:non1wordsrev)
...
\begin{equation}
g_k^n\left(x\right)=\left(k^n-\sum_{j=x-1}^{n}\binom{n}{j}\left(k-1\right)^{n-j}\right)+\sum_{j=x-1}^{n}\binom{n}{j}g^{n-j}_{k-1}\left(x\right),
(#eq:recursiverev)
